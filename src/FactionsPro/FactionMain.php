...
class FactionMain extends PluginBase implements Listener {
	...
	public function formatMessage($string, $confirm = false) {
		if($confirm) {
			return TextFormat::ITALIC . TextFormat::DARK_BLUE . "{" . TextFormat::GOLD . "MPE" . TextFormat::DARK_BLUE . "} " . TextFormat::GREEN . "$string";
		} else {	
			return TextFormat::ITALIC . TextFormat::DARK_BLUE . "{" . TextFormat::GOLD . "MPE" . TextFormat::DARK_BLUE . "} " . TextFormat::YELLOW . "$string";
		}
	}
